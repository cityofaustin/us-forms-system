  ...
  return function (_Component) {
    ...
    _createClass(CalendarDateWidget, [{
      ...
      value: function isIncomplete(_ref2) {
        ...
        if (!month || !day || !year) {
          return true;
        } else if (this.validation === 'pastOnly' && (0, _dateFns.isAfter)(new Date(year, month - 1, day), new Date())) {
          return true;
        } else if (this.validation === 'futureOnly' && (0, _dateFns.isBefore)(new Date(year, month - 1, day), new Date())) {
          return true;
        } else {
          return false;
        }

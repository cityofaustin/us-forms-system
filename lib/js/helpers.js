...
exports.removeFieldFromReview = removeFieldFromReview;
...
/*
  ...
  */
function removeFieldFromReview(pageState) {
  var uiSchema = pageState.uiSchema;
  var schema = pageState.schema;

  if (uiSchema['ui:removeFieldFromReview']) {
    var removableWidget = uiSchema['ui:removeFieldFromReview'];
    ...
    try {
      for (var _iterator = Object.getOwnPropertyNames(uiSchema)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var key = _step.value;
